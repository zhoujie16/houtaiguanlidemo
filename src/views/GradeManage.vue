        ...
        <el-main>
            <el-form :model="queryGradeForm" :inline="true" size="small">
                <el-form-item label="开始学届">
                    <el-input v-model="queryGradeForm.startGrade"></el-input>
                </el-form-item>
                <el-form-item label="结束学届">
                    <el-input v-model="queryGradeForm.endGrade"></el-input>
                </el-form-item>
                <el-form-item size="small">
                    <el-button @click="queryGradeAction">查询</el-button>
                    <el-button type="primary" @click="dialogVisible = true">新增</el-button>
                    <el-button @click="delGradeAction">删除</el-button>
                </el-form-item>
            </el-form>
